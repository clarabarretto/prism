									...
									<div className="grid md:grid-cols-2 gap-3">
										{regulations.map(regulation => (
											<GlassCard
												...
												className={`p-4 cursor-pointer transition-all duration-300 ${formData.regulations.includes(regulation.id)
														? "border-blue bg-blue/20"
														: "hover:border-blue/50"
													}`}
											>
												<div className="flex items-start space-x-3">
													<div className={`w-5 h-5 rounded border-2 flex items-center justify-center mt-0.5 ${formData.regulations.includes(regulation.id)
															? "border-blue bg-blue"
															: "border-gray-2"
														}`}>
